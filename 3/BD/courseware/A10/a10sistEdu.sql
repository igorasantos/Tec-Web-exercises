...
--
-- Host: localhost    Database: a10sistEdu
-- ------------------------------------------------------
...
INSERT INTO `alunos` VALUES (1,'Joao','Rua da Li','São Paulo'),(10,'Maria','Avenida Paulista','São Paulo');
...
CREATE TABLE `disciplina` (
  ...
  `dis_carga` int(11) DEFAULT NULL,
  `dis_professor` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-04-11  6:03:44
