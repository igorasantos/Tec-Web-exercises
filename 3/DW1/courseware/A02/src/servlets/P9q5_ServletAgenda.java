...
@WebServlet("/P9q5_ServletAgenda")
public class P9q5_ServletAgenda extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public P9q5_ServletAgenda() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		javaClasses.P9q5_Contato contatoRecebido = new javaClasses.P9q5_Contato();
        ...
        out.write(
				...
				+ "<body>"
				+ "<p>"
					+ "Contato: <strong>"+contatoRecebido.getNome() + "</strong> adicionado com sucesso (via GET)!</p>"
				+ "<p>Dados completos:</p>"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.write(
				...
				+ "<body>"
				+ "<p>"
					+ "Contato: <strong>"+contatoRecebido.getNome() + "</strong> adicionado com sucesso (via POST)!</p>"
				+ "<p>Dados completos:</p>"
				+ "<p>Nome: "+contatoRecebido.getNome() + "</p>"
				+ "<p>Telefone: "+contatoRecebido.getTelefone() + "</p>"
				+ "<p>Data de nascimento: "
