...
@WebServlet("/P09q1bController")
public class P09q1bController extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public P09q1bController() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("pessoas", getPessoas());
		request.getRequestDispatcher("p09/q1b.jsp").forward(request,response);
	}
