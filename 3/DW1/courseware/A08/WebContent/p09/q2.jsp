			...
			<div class="table-responsive-md">
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							<th scope="row">Pattern=<br><span class="emph">"dd/MM HH:mm"</span></th>
							<td><fmt:formatDate value="${dtP0}" pattern="dd/MM HH:mm"/></td>
							<td><fmt:formatDate value="${dtP1}" pattern="dd/MM HH:mm"/></td>
							<td><fmt:formatDate value="${dtP2}" pattern="dd/MM HH:mm"/></td>
						</tr>
						<tr>
							<th scope="row">Pattern=<br><span class="emph">"dd/MM/yyyy HH:mm z"</span></th>
							<td><fmt:formatDate value="${dtP0}" pattern="dd/MM/yyyy HH:mm z"/></td>
							<td><fmt:formatDate value="${dtP1}" pattern="dd/MM/yyyy HH:mm z"/></td>
							<td><fmt:formatDate value="${dtP2}" pattern="dd/MM/yyyy HH:mm z"/></td>
						</tr>						
					</tbody>					
				</table>
			</div>
